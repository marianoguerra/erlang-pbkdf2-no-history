...
[Full erlang-pbkdf2 repo (see note below)]: https://github.com/basho/erlang-pbkdf2
...
NOTE:
    ...
    this repo is a clean import of the pbkdf2 module without the couchdb git
    history to avoid downloading 14MBs of history for a library with ~200 lines
    of code, if you want the full history use this repository:
